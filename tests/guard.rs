...
use macros::set_msg;
use macros::{guard_ctor, transition, try_from};
...
mod drop_guard_msg {
    ...
    guard_ctor!(new_armed, DropGuardMsg::new_armed("custom"), armed: "custom");
    guard_ctor!(new_disarmed, DropGuardMsg::new_disarmed("custom"), disarmed);
